...
from helpers.data_loader import ColorDataSetMV
...
class KidneyImagesLoader(pl.LightningDataModule):
    ...
    def get_train_dataset(self):
        ...
        dataset = ColorDataSetMV(get_content_of_folder(os.path.join(self.image_path, 'train')),
    ...
    def get_test_dataset(self):
        ...
        dataset_test = ColorDataSetMV(get_content_of_folder(os.path.join(self.image_path, 'test')),
